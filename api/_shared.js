// Prompt compartilhado entre realtime-session.js (voz) e chat.js (texto)
export const MARIA_INSTRUCTIONS = `
...
11.1 SOBRE A TRANSCRIÇÃO DE VOZ (apenas quando em modo de voz)
